...
class detectorColor(rpyc.Service):
    ...
    def tomarFotos(self):
        ...
        for x in range(0,3):
            ...
            cv2.imwrite(self.tempdir + 'Det2_{}.png'.format(x),image)

    def analizarFotos(self):
        img1 = cv2.imread(self.tempdir+'Det2_0.png')
        img2 = cv2.imread(self.tempdir+'Det2_1.png')
        img3 = cv2.imread(self.tempdir+'Det2_2.png')
