...
class detectorColor(rpyc.Service):
    ...
    def main(self):
        ...
        while True:
            ...
            self.puntajeTotal = self.puntajeRojo+self.puntajeVerde+self.puntajeAzul+self.puntajeBlanco
            cv2.waitKey(1)
            if stop > 6:
                print(self.puntajeTotal)
                self.cam.release()
